      ...
      <table className="min-w-full bg-white">
        <thead className="bg-blue-900  text-white rounded-t-xl overflow-hidden">
          <tr>
            ...
            <th className="px-4 py-4 border border-gray-300 ">From</th>
            <th className="px-4 py-4 border border-gray-300 ">To</th>
            <th className="px-4 py-4 border border-gray-300 ">Code</th>
            <th className="px-4 py-4 border border-gray-300 ">Type</th>
            <th className="px-4 py-4 border border-gray-300 ">Days/Hours</th>
