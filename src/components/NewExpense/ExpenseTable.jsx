  ...
  return (
    <div className="overflow-hidden rounded-xl border border-gray-200">
      <table className="min-w-full bg-white">
        <thead className="bg-blue-900 font-bold text-white rounded-t-xl overflow-hidden">
          <tr>
            <th className="py-2 px-4 border-r-2 border-gray-400 rounded-tl-xl">
              Profile
            </th>
            <th className="px-8 py-4 border border-gray-300 ">Name</th>
            <th className="px-4 py-4 border border-gray-300 ">Code</th>
            <th className="px-4 py-4 border border-gray-300 ">Type</th>
            <th className="px-4 py-4 border border-gray-300 ">Incurred on</th>
            <th className="px-4 py-4 border border-gray-300 ">Expense </th>
            <th className="px-4 py-4 border border-gray-300 ">Amount</th>
            ...
            >
              <td className="px-4 py-2 border border-gray-300">
                <div className="relative">
                  ...
                  />
                  {leave.isNew && (
                    <div className="absolute top-0 left-0 pr-3">
                      <svg
                        width="33"
                        height="33"
                        viewBox="0 0 33 33"
              ...
              <td className="px-4 py-2 border border-gray-300">{leave.name}</td>
              ...
              <td className="px-4 py-2 border border-gray-300">{leave.type}</td>
              <td className="px-4 py-2 border border-gray-300">
                {leave.incurredOn}
              </td>
              <td className="px-4 py-2 border border-gray-300">
              ...
              <td className="px-4 py-6 mt-2 flex gap-2 items-center justify-center">
                {leave.status === "Approved" ? (
                  <FaEye size={20} />
                ) : (
                  <>
